...
public class AttendanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterSpinner = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, TeacherMainActivity.divisions);
        assert spinner != null;
    ...
    public void loadListView(View view) {
        ...
        String qu = "SELECT * FROM STUDENT WHERE cl = '" + spinner.getSelectedItem().toString() + "' " +
                "ORDER BY ROLL";
        Cursor cursor = TeacherMainActivity.handler.execQuery(qu);
...
//        String title = "";
//        String note = "";
//        Cursor cursor1 = TeacherMainActivity.handler.execQuery(qn);
//        cursor1.moveToFirst();
